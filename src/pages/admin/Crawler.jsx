...
import Speaker from "../../components/admin/speaker.comp.admin"
import Startup from "../../components/admin/startup.comp.admin"
...
const Crawler = () => {
    ...
    const renders = [
        ...
        <Speaker nextIndex={4} goNextIndex={setIndex} speakers={data.speakers} />,
        <Startup nextIndex={5} goNextIndex={setIndex} startups={data.startups} />
    ]

    return (
        <div>
            <div className="d-flex justify-content-center gap-3 py-3">
                <button className="btn btn-primary" onClick={() => setIndex(0)}>Danh sách</button>
